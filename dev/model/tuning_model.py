...
class TuningModel(HyperModel):
    ...
    def build(self, hp: HyperParameters):
        ...
        hp_output_dim = hp.Choice("Embedding Outputs", [2 ** p for p in range(2, 10)], default=128)
        hp_transformers = hp.Int("Transformers", min_value=4, max_value=16, default=12)
        hp_heads = hp.Int("Attention Heads", min_value=4, max_value=16, default=12)
        ...
        hp_smoothing = hp.Float("Label Smoothing", min_value=0, max_value=0.2, default=0.0)
